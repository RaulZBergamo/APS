function myFunction(){
    if ( document.getElementById("sec-2").classList.contains('dark-theme')){
        ...
        document.getElementById("footer").classList.remove('footer-light');
        document.getElementById("footer").classList.add('footer-dark');
        ...
        document.getElementById("footer").classList.remove('footer-dark');
        document.getElementById("footer").classList.add('footer-light');
